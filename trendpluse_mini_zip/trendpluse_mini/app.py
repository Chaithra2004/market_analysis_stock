...
def ai_predictions_result():
    if request.method == 'POST':
        ...
        # File path to the dataset - using relative path
        file_path = "templates/trendpluse_dataset(csv).csv"
...
def market_analysis():
    if request.method == 'POST':
        ...
        if stock_data.empty:
            print("No data found for the specified company code.")
            return render_template(
                'market-analysis.html',
                error_message="No data found for the specified company code."
            )
